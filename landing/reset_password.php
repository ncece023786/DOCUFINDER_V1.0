...
<head>
    ...
    <title>Barangay 168 Deparo | Reset Password</title>
              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form>
                  ...
                  <div class="form-outline mb-4">
                    <h5 style="text-align: center;">A reset password link has been sent to example1@gmail.com</h5>
                  </div>

                  <div class="text-center pt-1 mb-5 pb-1">
                    <a class="text-muted">Follow the link to select a new password.</a>
                  </div>
