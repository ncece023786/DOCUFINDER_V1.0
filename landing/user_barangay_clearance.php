...
include 'config.php';
    ...
    if(isset($_POST['trigger'])) {
        ...
        $pob            = mysqli_real_escape_string($link,$_POST['pob']);
        $purpose        = mysqli_real_escape_string($link,$_POST['purpose']);
        $remarks        = mysqli_real_escape_string($link,$_POST['remarks']);
        $accounts_id    = $_SESSION['id'];
        $checking = mysqli_query($link,"SELECT * FROM forms_tbl WHERE category = 'Barangay Clearance'");
        ...
        if(empty($_FILES['paymaya_upload']['name'])) {
         ...
         if ($width != '96' && $height != '96') {
            ...
            $query = mysqli_query($link,"INSERT INTO forms_tbl (accounts_id,reference,profile,proof,amount,mop,name,address,dob,pob,purpose,remarks,category) VALUES ('$accounts_id','$reference','$image_name','$proof',50,'$mop','$name','$address','$dob','$pob','$purpose','$remarks','Barangay Clearance')");
            if($query) {
                if(empty($_FILES['paymaya_upload']['name'])) {
                ...
                $message = base64_encode(urlencode('Barangay Clearance form has been submitted.'));
                header('location: user_barangay_clearance.php?success=true&message='.$message);
            } else {
                $message = base64_encode(urlencode('Something went wrong.'));
                header('location: user_barangay_clearance.php?success=false&message='.$message);
            }
        }
                                ...
                                <ul id="main-menu" class="metismenu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="collapse in">
                                            ...
                                            <li class="active"><a href="user_barangay_clearance.php">Barangay Clearance</a></li>
                ...
                <div class="col-lg-9 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body wizard_validation">
                            <form id="wizard_with_validation" class="clearance_form" enctype="multipart/form-data" method="POST">
                                ...
                                <fieldset>
                                    <div class="row clearfix justify-content-center" style="padding-top: 15px;">
                                        <div class="col-lg-6 col-md-12">
                                            ...
                                            <div class="form-group">
                                              <label for="pob">Place of Birth <span class="asterisk">*</span></label>
                                            ...
                                            <div class="form-group">
                                              <label for="remarks">Remarks <span class="asterisk">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <div class="card">
                                                    ...
                                                    <div class="body">
                                                        <input type="file" class="dropify" name="files" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
