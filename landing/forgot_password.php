...
if(isset($_POST['button_reset'])) {
  ...
  if(mysqli_num_rows($checking) > 0) {
    ...
    $message = '
      ...
      Please click <a href="http://localhost/prototype/landing/reset.php?success=true&security_code='.$security_code.'">here</a> to reset your password. <br>
      <br><br>
      Thank you.
    ';
              ...
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <form method="POST">
                    ...
                    <?php if(@$_GET['success'] == 'true'  && $_GET['message']) { ?>
                    <p class="text-center"><?=urldecode(base64_decode($_GET['message']))?></p>
                    <div class="text-center pt-1 mb-5 pb-1">
                      <a href="login.php" class="btn btn-default text-muted  btn-block fa-lg mt-2" style="height: 50px;font-size:18px;outline:hidden; border: none;">Return To Log in</a>
                    </div>
